...
const Register = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // Add registration logic here, e.g., send data to a backend API
      ...
      <div className="w-full md:w-1/2 flex flex-col justify-center items-center p-8 md:p-16">
        <div className="w-full max-w-md bg-brand-white p-10 rounded-2xl shadow-xl border border-gray-100">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              className="w-full bg-brand-dark-brown text-brand-cream font-bold py-4 rounded-lg uppercase tracking-widest text-sm hover:bg-brand-gold hover:text-brand-dark-brown transition-all duration-300 shadow-lg shadow-brand-dark-brown/10 mt-4"
            >
              Sign Up
            </button>
          </form>
