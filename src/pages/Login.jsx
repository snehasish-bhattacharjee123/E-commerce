          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <input
                ...
                className="w-full p-3 bg-transparent border border-gray-200 rounded-lg text-brand-text focus:outline-none focus:ring-2 focus:ring-brand-gold/20 focus:border-brand-gold transition-all"
                required
              />
            </div>
            ...
            <button
              type="submit"
              className="w-full bg-brand-dark-brown text-brand-cream font-bold py-4 rounded-lg uppercase tracking-widest text-sm hover:bg-brand-gold hover:text-brand-dark-brown transition-all duration-300 shadow-lg shadow-brand-dark-brown/10"
            >
              Sign In
            </button>
          </form>
